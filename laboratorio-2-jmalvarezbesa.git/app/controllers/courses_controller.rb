class CoursesController < ApplicationController
  ...
  # GET /courses/1.json
  def show
    @student_courses = StudentCourse.where(:Course => Course.find(params[:id]))
  end
  ...
  def destroy
    @course.destroy
    respond_to do |format|
      format.html { redirect_to courses_url, notice: 'El curso fue eliminado exitosamente.' }
